...
function updatePositionMarker(fileIndex, coords) {
    ...
    // Add ID counter label below the marker
    const labelEl = document.createElement('div');
    labelEl.className = 'position-marker-label';
    ...
    labelEl.textContent = `#${fileIndex + 1}`;
...
function showMediaPins() {
    ...
    mediaFiles.forEach((file, index) => {
        if (file.coordinates) {
            ...
            // Add ID counter label below the marker
            const labelEl = document.createElement('div');
            labelEl.className = 'media-marker-label';
            labelEl.style.position = 'absolute';
            labelEl.style.top = '100%';
            labelEl.style.left = '50%';
            labelEl.style.transform = 'translateX(-50%)';
                    ...
                    const onIdle = () => {
                        ...
                        try {
                            ...
                            mediaFeatures.forEach((f, index) => {
                                ...
                                // Draw ID counter label below the marker
                                ...
                                ctx2d.fillStyle = 'rgba(0, 0, 0, 0.8)';
                                ctx2d.fillRect(p.x - labelWidth/2 - 3, p.y + 15, labelWidth + 6, 16);
                                
                                // Draw label text
                                ctx2d.fillStyle = 'white';
                                ctx2d.fillText(labelText, p.x, p.y + 17);
                            });
