    ...
    mediaFiles.forEach((file, index) => {
        if (file.coordinates) {
            ...
            markerEl.title = file.filename;
             ...
             if (file.type === 'image') {
                 // Add filename above image with semi-white background
                 const filenameDiv = document.createElement('div');
                 filenameDiv.style.width = '180px';
                 filenameDiv.style.backgroundColor = 'rgba(255, 255, 255, 0.9)';
                 filenameDiv.style.color = '#333';
                 filenameDiv.style.textAlign = 'center';
                 filenameDiv.style.padding = '6px 0';
                 filenameDiv.style.fontSize = '11px';
                 filenameDiv.style.fontWeight = '500';
                 filenameDiv.style.borderRadius = '4px 4px 0 0';
                 ...
                 img.style.margin = '0';
                 img.style.padding = '0';
                 img.style.borderRadius = '0 0 4px 4px';
                 popupContent.appendChild(img);
             } else {
                 // Add filename above video with semi-white background
                 const filenameDiv = document.createElement('div');
                 filenameDiv.style.width = '180px';
                 filenameDiv.style.backgroundColor = 'rgba(255, 255, 255, 0.9)';
                 filenameDiv.style.color = 'rgba(255, 255, 255, 0.9)';
                 filenameDiv.style.textAlign = 'center';
                 filenameDiv.style.padding = '6px 0';
                 filenameDiv.style.fontSize = '11px';
                 filenameDiv.style.fontWeight = '500';
                 ...
                 video.controls = true;
                 video.style.borderRadius = '0 0 4px 4px';
