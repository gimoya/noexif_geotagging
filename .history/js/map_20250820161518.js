...
function updatePositionMarker(fileIndex, coords) {
    ...
    idLabel.style.top = '-8px';
    idLabel.style.right = '-8px';
    idLabel.style.background = '#333';
    ...
    idLabel.style.zIndex = '1000';
    idLabel.textContent = fileIndex + 1;
    
    // Create container for marker and label
    const containerEl = document.createElement('div');
    containerEl.style.position = 'relative';
    containerEl.appendChild(markerEl);
    containerEl.appendChild(idLabel);
